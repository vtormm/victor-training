...
const CATS = { sup_anterior: ['Tren superior · anterior', 'k-sup'], sup_posterior: ['Tren superior · posterior', 'k-sp'], inf_anterior: ['Tren inferior · anterior', 'k-ant'], inf_posterior: ['Tren inferior · posterior', 'k-pos'], funcional: ['Funcional (sin máquina)', 'k-fun'] };
const GROUPS = [['Tren superior', ['sup_anterior', 'sup_posterior']], ['Tren inferior', ['inf_anterior', 'inf_posterior']], ['Funcional', ['funcional']]];
